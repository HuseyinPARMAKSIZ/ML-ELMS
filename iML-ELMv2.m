...
DenSay=1; %  number of runs
Time=[];
Train_RMSE=[]; Test_RMSE=[]; % Cost array in terms of RMSE 
empty_solution.Ytrain=[]; empty_solution.Ytest=[]; solution=repmat(empty_solution,1);
...
disp(MtrcTe);
save results\iIML-ELM2-L3-Classification.mat
